...
::: {.question data-latex=""}
Given an observed sequence of outcomes $O = 3661634$ and two possible state sequences $s_1 = LLLFFFF$ and $s_2 = FFFFFFF$ (where $F$ = Fair and $L$ = Loaded), what are the joint probabilities $P(O, p_1)$ and $P(O, p_2)$ in the HMM described above?
::: 
...
P(O|s_1) =& t_{L,3} \times t_{L,6}^2 \times t_{F,1} \times t_{F,6} \times t_{F,3} \times t_{F,4} = 0.1 \times 0.5^2 \times (\frac{1}{6})^4 = 1.9 \times 10^{-5} \\
P(O|s_2) =& t_{F,3} \times t_{F,6}^2 \times t_{F,1} \times t_{F,6} \times t_{F,3} \times t_{F,4} = (\frac{1}{6})^7 = 3.57 \times 10^{-6} \\
P(O,s_1) =& P(O|s_1) \times P(s_1)= 1.9 \times 10^{-5} \times 0.0069 \\
P(O,s_2) =& P(O|s_2) \times P(s_2)= 3.57 \times 10^{-6} \times 0.6616
\end{align*}
::: 
...
::: {.answer data-latex=""}
\begin{align*}
P(O,s_1) &= 1.34 \times 10^{-7}\\
P(O,s_2) &= 2.36 \times 10^{-6}
\end{align*}
::: 
