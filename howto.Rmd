...
There are no deadlines when exercises should finished.
...
```{r, echo=FALSE, out.width="100%", fig.align='left'}
knitr::include_graphics("figures/howto/question.png")
```
...
In Github Classroom we provide automated testing for solutions written in python. You are of course welcome to use whatever language you prefer, but the automatic tests will not work for other languages than python.
...
```{r, echo=FALSE, out.width="100%", fig.align='left'}
knitr::include_graphics("figures/howto/github-link.png")
```
