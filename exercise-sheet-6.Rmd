...
We wish to find sequences related to a query sequence of 28 residues in a database of 1 billon sequences. Since this sequence belongs to a highly conserved gene family, we decide to use the PAM30 matrix.
...
Our supervisor has asked us to find homologous sequences of a gene which belongs to a highly diverged gene family. In that case, we decide to use the PAM250 matrix, since it provides the best sensitivity. What are the implications of using PAM250 instead of PAM30?
